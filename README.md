...
Godot 4.7.2 / Windows向け、コントローラー対応の生態系ダンジョン防衛ゲーム。1面試作 v0.4（勇者モーション対応版）です。

![ゲーム画面](docs/images/v04/battle.png)
...
[勇者の行動とシート対応](docs/hero-v0.4.md)：分岐での見回し、突入・捕獲時の喜び、方向別攻撃、死亡から骨への切り替え。
...
厚みのある土、苔・結晶、通路の壁際の影、描き分けた斧戦士と魔法使い、拡大した魔物、ツルハシカーソルを追加しました。十字キー・X・LBの操作と生態系ルールは維持しています。
...
- カーソル、連続掘り、追跡カメラ、地下深度表示、ステータス、効果音。
